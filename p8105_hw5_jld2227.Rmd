...
spaghetti_facet <- spaghetti_con_exp + 
  facet_grid(~arm) + #creates a faceted version of the orignal plot.
  labs(title = "Subject Study Measurements by Week, in Control and Treatment") #modifies the title
library(patchwork) #brings in the patchwork pacage, which allows plotting multiple plots in specific arrangements
spaghetti_con_exp / spaghetti_facet #plots the output with patchwork arragement,  regular at the top, facet plot at the bottom in this case.
